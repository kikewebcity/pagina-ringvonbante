...
const Accesorios = () => {
  ...
  const handleBuy = (productName) => {
    const message = `Hola Ringvonbante, estoy interesado en: ${productName}. Quisiera saber precio y detalles.`;
    const url = `https://wa.me/${myNumber}?text=${encodeURIComponent(message)}`;
    window.open(url, '_blank');
  };

  // ==========================================
  // 2. LISTA DE PRODUCTOS (Ya sin necesidad de campo precio visual)
  // ==========================================
  
  const itemsGaleria = [
    // --- FILA 1 ---
    { id: 1, type: 'product', category: 'ANILLOS', nombre: "Anillo Cota de Luna", img: img1 },
    { id: 2, type: 'product', category: 'COLLARES', nombre: "Colgante Venado", img: img2 },
    { id: 3, type: 'product', category: 'PULSERAS', nombre: "Brazalete Industrial", img: img3 },

    // --- FILA 2 ---
    { id: 100, type: 'process', category: 'PROCESO', text: "FUEGO Y METAL: EL ORIGEN.", img: imgProceso1, isVideo: true },
    { id: 4, type: 'product', category: 'ANILLOS', nombre: "Anillo Crudo", img: img4 },
    { id: 5, type: 'product', category: 'COLLARES', nombre: "Collar Estructura", img: img5 },
    
    // --- FILA 3 ---
    { id: 6, type: 'product', category: 'ARETES', nombre: "Aretes Fusión", img: img6 },
    { id: 7, type: 'product', category: 'ANILLOS', nombre: "Anillo Negro Mate", img: img7 },
    { id: 8, type: 'product', category: 'COLLARES', nombre: "Dije Mecánico", img: img8 },

    // --- FILA 4 ---
    { id: 9, type: 'product', category: 'PULSERAS', nombre: "Pulsera Eslabones", img: img9 },
    { id: 101, type: 'process', category: 'PROCESO', text: "NO HAY MOLDES. SOLO MÚSCULO Y PLATA.", img: imgProceso2, isVideo: false },
    { id: 10, type: 'product', category: 'ANILLOS', nombre: "Anillo Solitario", img: img10 },

    // --- FILA 5 ---
    { id: 11, type: 'product', category: 'COLLARES', nombre: "Collar Minimalista", img: img11 },
    { id: 12, type: 'product', category: 'PULSERAS', nombre: "Brazalete Óxido", img: img12 },
    { id: 13, type: 'product', category: 'ARETES', nombre: "Aretes Geométricos", img: img13 },
    
    // --- EXTRAS ---
    { id: 14, type: 'product', category: 'ANILLOS', nombre: "Anillo Doble", img: img14 },
    { id: 15, type: 'product', category: 'COLLARES', nombre: "Colgante Raw", img: img15 },
  ];
